...
KNOWN_MODELS = ['High Static Duct', 'Olivia Midnight', 'Universal Remote With Humidity Sensor', 'MIA NY', 'One Way Cassette', 'Slim Duct', 'PEAQ', 'Astoria', 'Floor Ceiling', 'Ceilling Cassette', 'Console', 'PEAQ Auxiliary Heater', 'Slim Duct Hyper', 'A6Duct', 'Four Way Cassette', 'PEAQ Air Handler Outdoor Unit', 'Universal Floor Ceiling', 'A7Duct', 'Universal Remote With Humidity Control', 'Ceiling Cassette', 'Medium Static Duct', 'Smart Wired Thermostat(120)', 'High Static Slim Duct', 'Olivia', 'Slim Duct Regular', 'Multi-Position Air Handler Unit', 'Auxiliary Heater', 'Medium Static Slim Duct', 'Regular Multi-Zone', 'Universal Remote Without Humidity Control', 'PEAQ Air Handler Unit', 'Smart Kit', 'Multi Zone Outdoor Units', 'Smart Thermostat', 'Hyper Multi-Zone', 'Mini Floor Console', 'Astoria Pro', 'Air Handler Unit']
